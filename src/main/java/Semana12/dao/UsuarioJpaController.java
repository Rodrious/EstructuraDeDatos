package Semana12.dao;

import Semana12.dao.exceptions.NonexistentEntityException;
...
public class UsuarioJpaController implements Serializable {
    ...
    public Usuario validar(Usuario usuario) {
        ...
        try {
            ...
            q.setParameter("logiUsua", usuario.getLogiUsua());
            q.setParameter("passUsua", usuario.getPassUsua());
