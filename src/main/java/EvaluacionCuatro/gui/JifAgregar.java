...
public class JifAgregar extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Agregar un nuevo Alumno");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Se registro el alumno con codigo " + codigo + " correctamente.");

            limpiarCampos();
            txtCodigo.requestFocus();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Hubo un error al registrar al alumno.");
        }
